...
Grounded candidates, ordered by resonance, derived from the audience's world
(a north Bristol driver beside a car that will not start, and the Severnside
industrial estate the garage trades from):

1. Severnside industrial estate signage and wayfinding
2. Instrument cluster and warning-lamp iconography
3. Trade tool storage and shadow boards
4. OBD-II diagnostic readout
5. Registration plate and DVLA document typography
6. Haynes manual technical illustration
7. **The motor factor trade counter** ← assigned

Ruts kept out of the list: the stock UK garage site (blue-red gradient, stock
photo of a smiling mechanic, MOT price banner) and its predictable opposite,
the dark "performance" garage with a supercar hero.
...
| Cephalopod chromatophore skin | No purchase on the audience's world. |
| Menhera pastel mascot | No purchase on the audience's world. |

No challenger beat the assigned direction on both axes, so The Trade Counter
was presented as the committed direction.
...
in PRODUCT.md as a brand commitment rather than a one-off.

Craft bar, asked and answered in the same round: **the user's own
showroomdetailing and CJValeting sites**. Accent: **signal amber**.
...
- **Accent is signal amber, not champagne gold or claret.** Workshop and
  ...
  strongest available contrast for the phone button on graphite.
- **There is no photography, and none may be invented.** The house canon seats
  its hero on a full-bleed photo of the owner's own work. This business has no
